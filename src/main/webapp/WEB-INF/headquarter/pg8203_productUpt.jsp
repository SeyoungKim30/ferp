		...
		<div id="insform">
			...
			<form method="post" enctype="multipart/form-data"
				...
				<div>
					...
					<input type="text" name="opposite" value="${product.opposite}" 
				...
				<div>
					<div class="custom-file">
						...
						<input type="text" value="${product.img}" readonly name="multipartfile" id="file01"><br>
						<input type="file" name="multipartfile" id="file01"> 
					</div>
				</div><br>
				<button id="uptBtn" class="btn btn-secondary" type="button">수정</button>
