...
INSERT INTO QA VALUES ('QA||TO_CHAR(sysdate, 'YYMMDD')','1234567890',QANUM_SEQ.nextval,N,);
INSERT INTO QA VALUES('QA'||to_char(to_date('20230222', 'YYMMDD'), 'YYMMDD'), 
'1234567891',QANUM_SEQ.nextval,'N', (SELECT empnum FROM store WHERE frreginum='1234567891'), 
to_date('20230222', 'YYMMDD'),NULL,NULL); --항목추가

SELECT QANUM_SEQ.nextval FROM dual;