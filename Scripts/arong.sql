...
SELECT * FROM STOCK s ;
INSERT INTO STOCK values('PD10002','1234567890',sysdate,-1,10-1,NULL);
INSERT INTO STOCK values('PD10002','9999999999',sysdate,-10,40-10,NULL);
...
-- 본사 재고 관리 조회
SELECT s.STOCKDATE ,p.PRODUCTNUM ,p.PRODUCTNAME ,p.PRICE ,s.APPLYAMOUNT 
FROM PRODUCT p, STOCK s
WHERE p.PRODUCTNUM = s.PRODUCTNUM
AND s.FrRegiNum = '1234567890';
SELECT * FROM PRODUCT p ;
